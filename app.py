...
st.markdown("""
    <style>
        ...
        [data-testid="appCreatorAvatar"], div[class*="_link_gzau3_"] {
            opacity: 0 !important; width: 0 !important; height: 0 !important; pointer-events: none !important;
        }
        ...
        div[data-testid="metric-container"]:nth-of-type(1) [data-testid="stMetricValue"] { color: #2ecc71 !important; }
        div[data-testid="metric-container"]:nth-of-type(2) [data-testid="stMetricValue"] { color: #e74c3c !important; }
    </style>
...
if p_total or r_total:
    ...
    if exibir_saldo:
        ...
        c3.markdown(f"""
            <div style="padding: 0.5rem 0px;">
                <label style="color: rgb(157, 161, 176); font-size: 14px;">Saldo Líquido</label>
    ...
    fig.update_layout(
        ...
        hoverlabel=dict(bgcolor="#2b2b2b", font_size=14, font_family="Arial")
    )
    st.plotly_chart(fig, use_container_width=True, config={'displayModeBar': False})
else:
    st.info(f"Nenhum lançamento em aberto encontrado entre {data_ini.strftime('%d/%m/%Y')} e {data_fim.strftime('%d/%m/%Y')}.")
