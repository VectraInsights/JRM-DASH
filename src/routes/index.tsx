...
import { listarEmpresas, getDashboard } from "@/lib/contaazul.functions";
  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground font-sans relative overflow-hidden">
      ...
      >
        ...
        <button
          onClick={() => refetch()}
          className="mt-2 w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-brand to-brand-2 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-brand/30 hover:shadow-brand/50 transition-shadow"
        >
