...
def buscar_ca_api(endpoint, token, d_ini, d_fim):
    ...
    while True:
        # Removido o 'Z' e o 'T' para testar compatibilidade direta com a busca por data
        params = {
            "pagina": pagina,
            "tamanho_pagina": 100,
        ...
        for i in itens:
            # Cálculo do valor líquido pendente
...
def listar_dados(empresa: str, data_inicio: str, data_fim: str):
    ...
    # Endpoints de busca conforme sua documentação
